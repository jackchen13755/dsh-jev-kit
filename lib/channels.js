...
export const CHANNELS = {
    ...
    private_scan: {
        ...
        questions: state => ({
            ...
            personal: noul('Does `text` contain personal or identifying information about a real person — a home directory path belonging to a person, a personal email address, a phone number, a full name tied to an account, or an internal username?', 'personal or identifying information about a real person is present', 
            /*
